...
const CampaignCard = () =>
{
    ...
    return <Card>
        <Stack direction={'row'}>
            <Avatar variant={'square'} src={'https://marketplace.canva.com/EAFltIh8PKg/1/0/1600w/canva-cute-anime-cartoon-illustration-girl-avatar-J7nVyTlhTAE.jpg'} />
            <Stack>
