...
const DetailHeader = () => {
    return <Stack direction={"row"} alignItems={'center'} justifyContent={'space-between'} width={'100%'}>
        <Stack direction={'row'} alignItems={'center'}>
            <ArrowBackIosIcon/>
            <Avatar src={'https://ipwatchdog.com/wp-content/uploads/2018/03/pepe-the-frog-1272162_640.jpg'}/>
            <Stack>
                <Stack direction={'row'}>
        ...
        <Stack direction={'row'} alignItems={'center'}>
            ...
            <Button variant={'contained'}>Earn Now</Button>
        </Stack>
    </Stack>
}
