 ...
 * @param address - The Solana wallet address (base58 encoded public key)
...
export function isValidSignature(
  address: string,
  signature: string,
  message: string = `Connect wallet ${address} to Commi.`,
): boolean {
  try {
    ...
    // Invalid address format or signature format
